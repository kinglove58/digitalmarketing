    ...
    <>
      <Maxwithwrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-gray sm:text-6xl">
            {" "}
            Your Market Place for High-quality
            <span className="text-blue-500"> digital assets</span>
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground ">
            Welcome to DigitalHippop. Every assest on our plartform is verigy by
            our team and it is of high quality.
          </p>
